        ...
        <div class="row">
            ...
            <div class="col-md-10">
                        ...
                        <div class="row">
                            <div class="col-sm-4 border-right">
                                <div class="description-block">
                                    ...
                                    <span class="description-text"><?= $row['no_identitas']; ?></span>
                                </div>
                                <!-- /.description-block -->
                            </div>
                            <!-- /.col -->
                            ...
                            <div class="col-sm-4">
                                <div class="description-block">
                                    ...
                                    <span class="text-center"><?= $row['username']; ?></span>
                                </div>
                                <!-- /.description-block -->
                            </div>
                            <div class="col-sm-4">
                                <div class="description-block">
                                    ...
                                    <span class="text-center"><?= $row['password']; ?></span>
                                </div>
                                <!-- /.description-block -->
                            </div>
                            <div class="col-sm-4">
                ...
                <div class="text-center">
                    <a href="<?= $baseUrl; ?>views/dataAdmin.php"> <button class="btn btn-primary text-center">Kembali</button>
                    </a>
                </div>
                <!-- /.widget-user -->
            </div>
