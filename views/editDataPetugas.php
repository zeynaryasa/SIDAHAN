                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="no_identitas" required value="<?= $row['no_identPetugas']; ?>" placeholder="no. identitas petugas" autocomplete="off">
                            </div>
                            <!-- /.form-group -->
                            <div class="form-group">
                                <label>Nama Petugas</label>
                                <input type="text" class="form-control" name="nama" required value="<?= $row['nama']; ?>" placeholder="Masukan nama lengkap" autocomplete="off">
                        ...
                        <div class="col-md-12 mt-3">
                            <div class="form-group text-center">
                                <button class="btn btn-primary" type="submit" name="btnEditPetugas">Simpan</button>
                            </div>
                        </div>
                        <!-- /.form-group -->
                    </div>
